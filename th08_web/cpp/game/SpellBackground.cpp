...
void SpellBackground::draw(AnmRenderer& r){
    ...
    auto& a=*ap;a.scale={-1.5f,-1.75f};a.pos={416,464,.7f};const auto color=a.color1;a.color1.d3dColor=i32(0xffe0c0c0);r.draw_2d(a);a.scale={1.5f,1.75f};a.pos={32,16,.5f};a.color1=color;
    auto& b=*bp;b.rotation.z=Scalar::mul(b.rotation.z,-1);b.pos.z=.6f;const auto other=b.color1;b.color1.d3dColor=i32(0xffe0c0c0);r.draw_2d(b);r.flush();b.rotation.z=Scalar::mul(b.rotation.z,-1);b.pos.z=.5f;b.color1=other;r.set_depth_func(DepthFunc::Always);
}
}
