...
const expectedPath = resolve(option('--expected') ?? '');
const actualPath = resolve(option('--actual') ?? '');
...
const fixture = {replaySha256: expected.replay.sha256}, identity = expected.identity;
